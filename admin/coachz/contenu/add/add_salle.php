...
if ($_POST["f"]==1) { 
  ...
  if ($test->Count==0) {
	...
	$longitude=$_POST["long"];
		...
		$cree=$salle->ajouter_salle($titre,$adresse,$tel,$latitude,$longitude);
		if($cree=="1"){ 
			
			echo' <meta http-equiv="refresh" content="0;URL=acceuil.php?p=salle&add">';
		}
		else { echo $message="<center>Erreur : Ajout non &eacute;tablie!</center>";}
}	}
                ...
                <div class="span12 ">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>Chercher la positionnement de votre salle de sport </h4>
                        </div>
                ...
                <div class="accordion-inner">
                   <form id="form" method="post" action="" class="form-horizontal">
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="te" name="titre"  type="text"  value="<?php echo $formtitre ; ?>" class="input-xlarge"  />
                                    </div>
                                </div>
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="adr" name="adr"  type="text"  value="<?php echo $formadr ; ?>" class="input-xlarge"  />
                                    </div>
                                </div>
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="tel" name="tel"  type="text"  value="<?php echo $formtel ; ?>" class="input-xlarge"  />
                                    </div>
                                </div>
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="lat" name="lat"  type="text" readonly value="<?php echo $formlat ; ?>" class="input-xlarge"  />
                                    </div>
                                </div>
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="long" name="long"  type="text"  readonly value="<?php echo $formlong ; ?>" class="input-xlarge"  />
                                    </div>
                                </div>

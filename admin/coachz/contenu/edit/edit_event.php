...
if ($_POST["f"]==1) { 
  ...
  if ($test->Count==0) {
	...
	$edit=$evenement->modifier_evenement($id_evenement,$titre,$date,$heure,$description,$adresse,$organiseur);
		if($edit=="1"){ 
				
			echo' <meta http-equiv="refresh" content="0;URL=acceuil.php?p=evt&modif">';
		}
		else { echo $message="<center><strong>Erreur : Ajout non &eacute;tablie!</strong></center>";}
}	}
$liste=$evenement->afficher_evenement($_GET['id']);	
?>
  	<div class="row-fluid">
					<div class="span12">
					...
					<select name="minute" id="miute"> <?php 
                      ...
                      <?php }?>
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="description" name="description"   value="<?php echo $formdescription ; echo $liste[4][0] ; ?>" class="input-xlarge" />
                                    </div>
                                </div>
								<div class="control-group">
                                    <label class="control-label <?php echo $test-> fieldError("adresse","fieldreq");?>" >Adresse</label>
                                    <div class="controls">
                                        <input type="text" id="adresse" name="adresse"   value="<?php echo $formadresse ; echo $liste[5][0] ; ?>" class="input-xlarge" />
                                    </div>
                                </div>
								<div class="control-group">
                                    <label class="control-label <?php echo $test-> fieldError("organiseur","fieldreq");?>" >Organiseur</label>
                                    <div class="controls">
                                        <input type="text" id="organiseur" name="organiseur"   value="<?php  echo $liste[6][0] ; ?>" class="input-xlarge" />
                                    </div>
                                </div>
